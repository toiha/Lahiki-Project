			...
			<div class="row">
				<div class="col-xs-12 col-md-3 left-feild">
					<div class="be-vidget back-block">
						<a class="btn full color-1 size-1 hover-1" href="{{ URL::to('site/profil') }}"><i class="fa fa-chevron-left"></i>Retour à mon profil</a>
					</div>
				...
				<div class="col-xs-12 col-md-9 _editor-content_">
					{!! Form::model($utilisateur, ['method' => 'POST','route' => ['updateprofil', $utilisateur->id]]) !!} 
							...
							<div class="be-large-post-align">
								<div class="be-change-ava">
									<a class="btn color-4 size-2 hover-7 be-ava-user style-2" id="lfm" data-input="thumbnail" data-preview="holder">
										<img id="holder" src="{{ ($utilisateur->avatar != null ? $utilisateur->avatar : '/img/ava_10.jpg' )}}" style="margin-top:15px;max-height:100px;">
								...
								<div class="row">
									<div class="input-col col-xs-12 col-sm-6">
										<div class="form-group fg_icon focus-2">
											...
											{!! Form::text('nom', null, array('class' => 'form-input')) !!}
										</div>							
									</div>
									<div class="input-col col-xs-12 col-sm-6">
										<div class="form-group focus-2">
											<div class="form-label">Prénom</div>									
											{!! Form::text('prenom', null, array('class' => 'form-input')) !!}
										</div>								
									</div>
									<div class="input-col col-xs-12">
										<div class="form-group focus-2">
											<div class="form-label">Email</div>									
											{!! Form::text('email', null, array('class' => 'form-input')) !!}
										</div>								
									</div>
									<div class="input-col col-xs-12">
										<div class="form-group focus-2">
											<div class="form-label">Adresse</div>									
											{!! Form::text('adresse', null, array('class' => 'form-input')) !!}
										</div>								
									</div>
									...
									<div class="input-col col-xs-12">
										<div class="form-group focus-2">
											<div class="form-label">Ville</div>																				 
											 <input class="input-signtype" name="ville_text"  value="{{ $utilisateur->ville != null ? $utilisateur->ville->nom : ''}}" 
                                    id="ville_autocomplete" type="text" placeholder="Saisissez votre ville" required="">
                                    <input name="ville_id" type="hidden" id="ville_id" value="{{ $utilisateur->ville_id }}"/>  
									...
									<div class="input-col col-xs-12 col-sm-6">
										<div class="form-group focus-2">
											...
											{!! Form::text('tel_fixe', null, array('class' => 'form-input')) !!}
										</div>								
									</div>
									...
									<div class="input-col col-xs-12 col-sm-6">
										<div class="form-group focus-2">
											<div class="form-label">Téléphone portable</div>									
											 {!! Form::text('tel_portable', null, array('class' => 'form-input')) !!}
										</div>								
									</div>
									...
									<div class="input-col col-xs-12">
										<div class="form-group focus-2">
											<div class="form-label">Je peux accueillir les étudiants des projets Wu Lahiki ?</div>									
											 {{ Form::radio('is_accueilleur', '1', ($utilisateur->is_accueilleur == '1')) }} Oui &nbsp;&nbsp; {{ Form::radio('is_accueilleur', '0', ($utilisateur->is_accueilleur == '0')) }} Non
										</div>								
									</div>	
								...
								<div class="row">
									<div class="input-col col-xs-12 col-sm-4">
										<div class="form-group focus-2">
											...
											{!! Form::password('old-password', array('class' => 'form-input')) !!}
										</div>								
									</div>
									<div class="input-col col-xs-12 col-sm-4">
										<div class="form-group focus-2">
											<div class="form-label">Nouveau mot de passe</div>									
											{!! Form::password('password', array('class' => 'form-input')) !!}
										</div>								
									</div>
									<div class="input-col col-xs-12 col-sm-4">
										<div class="form-group focus-2">
											<div class="form-label">Confirmer le nouveau mot de passe</div>									
											{!! Form::password('password_confirmation', array('class' => 'form-input')) !!}
										</div>								
									</div>
									<div class="col-xs-12">
								...
								<div class="row">									
									<div class="input-col col-xs-12">
										<div class="form-group focus-2">
											...
											<textarea class="form-input" required="" placeholder="Quelque chose sur vous" name="apropos">{{ $utilisateur->apropos }}</textarea>
										</div>
									</div>
									<div class="col-xs-12">
