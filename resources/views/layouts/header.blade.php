...
<header>
    ...
    <div class="container-fluid custom-container">
        <div class="row no_row row-header">
            <div class="brand-be">
                <a href="{{ URL::to('site/home') }}" ><img src="/img/logo.png" alt="logo" class="be_logo"></a>
                </a>
            </div>
            ...
            <div class="login-header-block">
                <div class="login_block">   
                    ...
                    <div class="be-drop-down login-user-down">
                        <img class="login-user" height="60" src="{{ (Auth::user()->avatar != null ? Auth::user()->avatar : '/img/ava_10.jpg' )}}" alt="">
                        <span class="be-dropdown-content"><span>Bonjour, {{ Auth::user()->prenom }} {{ Auth::user()->nom }}</span> </span>
                        <ul class="drop-down-list">
                            <li><a class="btn color-1-transparent size-2 " href="{{ URL::to('site/profil') }}" width="100%"><i class="fa fa-address-book" aria-hidden="true"></i> Voir mon profil</a></li>
                            <li><a class="btn color-1-transparent size-2" href="{{ URL::to('deconnexion') }}"  width="100%"><i class="fa fa-power-off" aria-hidden="true"></i> Se deconnecter</a></li>
                        </ul>                      
