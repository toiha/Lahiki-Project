...
<div class="row">
  ...
  <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 img-row">
    ...
    <div class="square clickable <?php echo e($item->is_file ? 'file' : 'folder'); ?>-item" data-id="<?php echo e($item_path); ?>">
      <?php if($thumb_src): ?>
    ...
    <div class="caption text-center">
      <div class="btn-group">
        <button type="button" data-id="<?php echo e($item_path); ?>" class="item_name btn btn-default btn-xs <?php echo e($item->is_file ? 'file' : 'folder'); ?>-item">
