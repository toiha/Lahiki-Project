                    ...
                    <div class="footer-block">
                        ...
                        <div class="row footer-list-footer">
                            ...
                            <ul class="link-list">
                                ...
                                <li><a href="<?php echo e(URL::to('site/equipe')); ?>" >Equipe</a></li>
    ...
    <div class="footer-bottom">
        <div class="container-fluid custom-container">
            <div class="col-md-12 footer-end clearfix">
                <div class="left">
                    <span class="copy">© 2017. tous droits réservés. <span class="white"><a href="<?php echo e(URL::to('site/home')); ?>" >Lahiki.Net</a></span></span>
